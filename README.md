...
**Задание Светофор:** При нажатии на цифровые кнопки, интенсивность окраски «звезд» меняется. Настроить очистку поля по кнопке `Clear`
